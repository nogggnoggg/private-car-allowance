...
- PHASE-003-T8（compose 附件 volume 接線 + 容器 build 驗證，Medium）：IN_PROGRESS。Task Graph 補遺：Spec §8 要求 compose 掛載 ATTACHMENT_STORAGE_ROOT，但 T2/T3/T7 均禁動 Docker，接線無人負責；且 production fail-fast 使 compose 不補即起不來。
