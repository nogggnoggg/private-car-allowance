...
| 項目 | 內容 |
|---|---|
| **本節狀態** | `COMPLETED`（PR #12 經人類批准合併至 main `9e00761`，2026-08-03；T1 即審與 T2+T3 合併複審皆 APPROVE、映射表 13 列 GREEN、CI 三 job 綠）。**§1~§13 主體維持 `COMPLETED` 且不受本節改寫**——本節只**新增** AC-21~AC-32 與新增之 400 情境，既有 AC-01~AC-20 之語意、既有成功路徑與 409/401/403 合約一律不變。 |
