...
| AC-21(a)~(d) | integration | `backend/test/integration/phase10-error-handler-leak.test.ts` | `AC-21: 兜底不記原文 ＋ 站點白名單 ＋ 路徑反向探針 ＋ wire 零變更` | T9 | `PENDING`（複審 M-1：AC-21(b) 掃描七型漏報——T9R 修復中；(a)(c)(d) 三段已證足額） |
